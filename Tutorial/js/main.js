jQuery(document).ready(function($){
	...
	function createNavigation(steps, n) {
		var tourNavigationHtml = '<div class="cd-nav"><span><b class="cd-actual-step">1</b> / '+n+'</span><ul class="cd-tour-nav"><li><a href="#0" class="cd-prev">&#171; 向前</a></li><li><a href="#0" class="cd-next">向后 &#187;</a></li></ul></div><a href="#0" class="cd-close">Close</a>';
